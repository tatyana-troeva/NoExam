...
<h1 class="land-top-text">Our No Exam Life Insurance Companies</h1>
	<div class="container">
    	<div class="form-container row">
    		...
    		<div class="eight columns"  style="float: right;">
				...
				<ul class="land-listing">
                	<li class="one">
                    	<h5>Top Rated</h5>
                        NoExam.com works with the top rated life insurance companies to provide customers with the best possible no exam policies.
                	...
                	<li class="three">
                        ...
                        <p class="lp">NoExam.com is a one stop shop for all of your life insurance needs. We specialize in selling no exam term life insurance products from companies like Sagicor, Mutual of Omaha, Metlife, Protective, and Phoenix. We are an A rated company with the Better Business Bureau and are Trust Guard approved.</p>
                </div>
            </div>
...
<form action="/post-page/" method="post"  class="form-inputs apply">
	...
	<div class="row" ID = "coverage-amount">
    	...
    	<div class="inputs"><select id = "fFaceAmount" name="fFaceAmount">
			...
			<option value="350000" 	<?php if ($_SESSION['fFaceAmount'] == 350000)										{ echo "selected";}?>>$350,000</option>
    ...
    <div class="row clearfix">
        ...
        <select name="fBirthMonth" class="small" id = "fBirthMonth">
			...
			<option value="12"	<?php if ($_SESSION['fBirthMonth'] == 1) 										{echo "selected";}?>>December</option>
		</select>
...
?>
	<h5 class="ltt" style="margin-top:60px;">Our Promise:</h5>
