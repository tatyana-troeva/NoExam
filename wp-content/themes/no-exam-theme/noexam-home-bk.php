...
<div id="plans">
    ...
    <div class="container">
        <form action="/post-page/" method="post" id="home-form">
            ...
            <h1>Applying for life insurance has never been easier</h1>
         	...
         	<div class="points">
            	<ul>
                	<li>
                        ...
                        <p>Fast and simple questionnaire will show you coverage options in just a few minutes. No exam or waiting period.</p>
                    </li>
                    <li>
...
<section class="blogcon">
    ...
    <div class="life-wrapper">
      ...
      <h3>Life Insurance Companies We Work With</h3>
        ...
        <p>National Life Group offers no medical policies available for purchase directly on our website. With thirty billion dollars in assets, National Life Group is recognized by A.M. Best as an “A / Excellent” rated insurance provider with an outstanding financial outlook.</p>
        </div>
        </div>
        </div>
        <div class="one-third column company">
        ...
        <div class="description company-description">
        <p>Founded in 1907, SBLI is one of the longest standing and most reputable insurance providers in the market today. With over two billion in assets, and an “A+ / Excellent” rating from A.M. Best, SBLI is a stable leader in the market place.</p>
        </div>
        </div>
        </div>
        <div class="one-third column company">
