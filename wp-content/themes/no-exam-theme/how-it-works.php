...
<h1 class="land-top-text">No Exam Life Insurance. How It Works</h1>
	<div class="container">
    		...
    		<div class="eight columns"  style="float: right;">
				...
				<ul class="land-listing">
                	<li class="one">
                        ...
                        Simply get your instant quote, answer the questions, and submit your application. A licensed agent will then process your application and update you on the status.
