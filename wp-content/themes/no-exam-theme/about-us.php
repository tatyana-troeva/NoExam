...
<h1 class="land-top-text">About No Exam Life Insurance</h1>
	<div class="container">
    		...
    		<div class="eight columns"  style="float: right;">
				...
				<ul class="land-listing">
                	...
                	<li class="three">
                        ...
                        <p class="lp">NoExam.com has been specializing in term life insurance policies that do not require a medical exam. See our customer reviews below to see what our current customers are saying about us.</p>
                </div>
            </div>
