...
<script type="text/javascript">
	...
	function getParams()
	{
		...
		vamdbDataStruct.ajax_rf = $('#referrer').val();
	...
	{
		var topForm = document.getElementById('top-inner-block');
		parentDiv = topForm.parentNode;
		var bottomForm = document.getElementById('bottom-inner-block');
		
		parentDiv.insertBefore(bottomForm,topForm);
...
<h1 class="land-top-text">No Exam Life Insurance. Fast and Affordable Coverage.</h1>
	<div class="container">
    	<div class="form-container row">
    		...
    		<div id = "top-inner-block" class="eight columns"  style="float: right;">
        	...
        	<div id = "bottom-inner-block" class="eight columns">
            	<div class="form-left">
...
<form action="/post-page/" method="post"  class="form-inputs apply">
	...
	<input type="hidden" name="referrer" id="referrer" value="2"></input>
	<div>
...
<div id="footer" class="footer-wrapper land-footer">
    	...
    	<script type="text/javascript">
	$(document).ready(function(){
		var hidd_field_ref = $('#refferr_on_wp-admin').val();
		$('#referrer').val(hidd_field_ref);
	});
	</script>
