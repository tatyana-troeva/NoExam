...
<div id="form-area">
		...
		<div class="row whitecon">         
			<div class="sixteen columns titlearealist">
				<ul>
					...
					<li><strong>Health Class:</strong> <?php echo $HealthClass;?></li>
				</ul>

				<div class="heightcon">
					<label>Height</label>
					<select name="fHeight_ft" id = "fHeight_ft">
                        <?php for( $i= 4 ; $i <= 6 ; $i++ ) {?>
                            <option value = "<?php echo $i; ?>" <?php if ($Height_ft == $i || ($i ==5 && !isset($Height_ft))) {echo "selected";}?>><?php echo $i; ?>ft</option>
                        <?php } ?>
					</select>
                    <select name="fHeight_in" id = "fHeight_in">
                        <?php for( $i= 0 ; $i <= 11 ; $i++ ) {?>
				...
				<div class="weightcon">
					<label>Weight</label>
                    <input style="float: left; height: 30px;" id = "" type="text" size=3  value="<?php if (isset($weight)){echo $weight;} else {echo "165";}?>" min="1" max="500" name="">
                    <label>&nbsp;lbs</label>
				</div>
    ...
    **/
    ...
    // build price array
    $prices = array('sbli' => array());
    $sbli_band = getSBLIBand($FaceAmount);
    $sbli_rate_class = getSBLIRateClassName($sbli_rate);
//    var_dump($sbli_prices);

    foreach ($sbli_prices as &$sbli_price):
        $sbli_price-> img_url = 'https://noexam.staging.wpengine.com/wp-content/themes/no-exam-theme/images/sb-logo.png';
        $sbli_price-> product_name = 'SBLI Term';
        $sbli_price ->rate_class = $sbli_rate_class;
                    ...
                    <div class="resultrow">
                        ...
                        <div class="resultcontent">
                            ...
                            <div class="resultcontentcol company">
                                <a href="#"><img src="<?=$prices['sbli'][$term]->img_url?>"></a>
                            </div>
                            <div class="resultcontentcol product">
                                <p><?=$prices['sbli'][$term]->product_name?></p>
                            </div>
                            <div class="resultcontentcol rateclass">
                                <p><?=$prices['sbli'][$term]->rate_class?></p>
                            </div>
                            <div class="resultcontentcol annual">
                                <p>$<?=number_format($prices['sbli'][$term]->annual, 3)?></p>
                            </div>
                            <div class="resultcontentcol monthly">
                                <p>$<?=number_format($prices['sbli'][$term]->monthly, 3)?></p>
                            </div>
